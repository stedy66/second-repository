(function(g){var window=this;'use strict';var CSa=function(a,b){return g.Ce(a,b)},DSa=function(a,b){b=b instanceof g.Cf?b:g.If(b,/^data:image\//i.test(b));
...
g.dk(a.u,b,c)},ESa=function(a){if(a instanceof g.ko)return a;
...
return c}throw Error("Not implemented");},FSa=function(a,b,c){if(g.La(a))try{g.nc(a,b,c)}catch(d){if(d!==g.br)throw d;
}else{a=ESa(a);try{for(;;)b.call(c,a.wj(),void 0,a)}catch(d){if(d!==g.br)throw d;}}},GSa=function(a,b){var c=[];
FSa(b,function(d){try{var e=g.Cr.prototype.u.call(this,d,!0)}catch(f){if("Storage: Invalid value was encountered"==f)return;throw f;}void 0===e?c.push(d):g.Br(e)&&c.push(d)},a);
return c},HSa=function(a,b){GSa(a,b).forEach(function(c){g.Cr.prototype.remove.call(this,c)},a)},ISa=function(a){if(a.va){if(a.va.locationOverrideToken)return{locationOverrideToken:a.va.locationOverrideToken};
if(null!=a.va.latitudeE7&&null!=a.va.longitudeE7)return{latitudeE7:a.va.latitudeE7,longitudeE7:a.va.longitudeE7}}return null},JSa=function(a,b){g.Sb(a,b)||a.push(b)},Q6=function(a){var b=0,c;
for(c in a)b++;return b},KSa=function(a){try{return g.C.JSON.parse(a)}catch(b){}a=String(a);
if(/^\s*$/.test(a)?0:/^[\],:{}\s\u2028\u2029]*$/.test(a.replace(/\\["\\\/bfnrtu]/g,"@").replace(/(?:"[^"\\\n\r\u2028\u2029\x00-\x08\x0a-\x1f]*"|true|false|null|-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?)[\s\u2028\u2029]*(?=:|,|]|}|$)/g,"]").replace(/(?:^|:|,)(?:[\s\u2028\u2029]*\[)+/g,"")))try{return eval("("+a+")")}catch(b){}throw Error("Invalid JSON string: "+a);},R6=function(a){if(g.C.JSON)try{return g.C.JSON.parse(a)}catch(b){}return KSa(a)},LSa=function(a,b,c,d){var e=new g.Qj(null,void 0);
...
a.user||"",this.avatar=a.userAvatarUri||"",this.obfuscatedGaiaId=a.obfuscatedGaiaId||"",this.theme=a.theme||"u",MSa(this,a.capabilities||""),NSa(this,a.experiments||""),this.brand=a.brand||"",this.model=a.model||"",this.year=a.year||0,this.os=a.os||"",this.osVersion=a.osVersion||"",this.chipset=a.chipset||"",this.mdxDialServerType=a.mdxDialServerType||"MDX_DIAL_SERVER_TYPE_UNKNOWN",a=a.deviceInfo)&&(a=JSON.parse(a),this.brand=a.brand||"",this.model=a.model||"",this.year=a.year||0,this.os=a.os||"",
this.osVersion=a.osVersion||"",this.chipset=a.chipset||"",this.clientName=a.clientName?a.clientName.toUpperCase():"UNKNOWN_INTERFACE",this.mdxDialServerType=a.mdxDialServerType||"MDX_DIAL_SERVER_TYPE_UNKNOWN")},MSa=function(a,b){a.capabilities.clear();
g.Jo(b.split(","),g.Pa(CSa,OSa)).forEach(function(c){a.capabilities.add(c)})},NSa=function(a,b){a.experiments.clear();
b.split(",").forEach(function(c){a.experiments.add(c)})},U6=function(a){a=a||{};
this.name=a.name||"";this.id=a.id||a.screenId||"";this.token=a.token||a.loungeToken||"";this.uuid=a.uuid||a.dialId||"";this.idType=a.screenIdType||"normal"},V6=function(a,b){return!!b&&(a.id==b||a.uuid==b)},PSa=function(a){return{name:a.name,
screenId:a.id,loungeToken:a.token,dialId:a.uuid,screenIdType:a.idType}},QSa=function(a){return new U6(a)},RSa=function(a){return Array.isArray(a)?g.tm(a,QSa):[]},W6=function(a){return a?'{name:"'+a.name+'",id:'+a.id.substr(0,6)+"..,token:"+((a.token?".."+a.token.slice(-6):"-")+",uuid:"+(a.uuid?".."+a.uuid.slice(-6):"-")+",idType:"+a.idType+"}"):"null"},X6=function(a){return Array.isArray(a)?"["+g.tm(a,W6).join(",")+"]":"null"},Y6=function(){return"xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,
function(a){var b=16*Math.random()|0;
return("x"==a?b:b&3|8).toString(16)})},SSa=function(a){return g.tm(a,function(b){return{key:b.id,
name:b.name}})},Z6=function(a,b){return g.Nb(a,function(c){return c||b?!c!=!b?!1:c.id==b.id:!0})},$6=function(a,b){return g.Nb(a,function(c){return V6(c,b)})},TSa=function(){var a=(0,g.Ky)();
a&&HSa(a,a.i.Mg(!0))},a7=function(){var a=g.Ny("yt-remote-connected-devices")||[];
g.hc(a);return a},USa=function(a){if(g.Tb(a))return[];
var b=a[0].indexOf("#"),c=-1==b?a[0]:a[0].substring(0,b);return g.tm(a,function(d,e){return 0==e?d:d.substring(c.length)})},VSa=function(a){g.My("yt-remote-connected-devices",a,86400)},c7=function(){if(b7)return b7;
...
g.Sb(a,b);g.Py()&&g.mc(a,b);a=USa(a);if(g.Tb(a))try{g.Ut("remote_sid")}catch(c){}else try{g.St("remote_sid",a.join(","),-1)}catch(c){}},WSa=function(){return g.Ny("yt-remote-session-browser-channel")},XSa=function(){return g.Ny("yt-remote-local-screens")||[]},YSa=function(){g.My("yt-remote-lounge-token-expiration",!0,86400)},ZSa=function(a){5<a.length&&(a=a.slice(a.length-5));
var b=g.tm(XSa(),function(d){return d.loungeToken}),c=g.tm(a,function(d){return d.loungeToken});
g.um(c,function(d){return!g.Sb(b,d)})&&YSa();
g.My("yt-remote-local-screens",a,31536E3)},$Sa=function(a,b){g.My("yt-remote-session-browser-channel",a);
g.My("yt-remote-session-screen-id",b);a=a7();b=c7();g.Sb(a,b)||a.push(b);VSa(a);d7()},e7=function(a){a||(g.Oy("yt-remote-session-screen-id"),g.Oy("yt-remote-session-video-id"));
d7();a=a7();g.Wb(a,c7());VSa(a)},aTa=function(){if(!f7){var a=g.Mr();
a&&(f7=new g.wr(a))}},bTa=function(){aTa();
return f7?!!f7.get("yt-remote-use-staging-server"):!1},g7=function(){var a=window.navigator.userAgent.match(/Chrome\/([0-9]+)/);
return a?parseInt(a[1],10):0},cTa=function(a){return!!document.currentScript&&(-1!=document.currentScript.src.indexOf("?"+a)||-1!=document.currentScript.src.indexOf("&"+a))},dTa=function(){return"function"==typeof window.__onGCastApiAvailable?window.__onGCastApiAvailable:null},h7=function(a){a.length?eTa(a.shift(),function(){h7(a)}):i7()},fTa=function(a){return"chrome-extension://"+a+"/cast_sender.js"},eTa=function(a,b,c){var d=document.createElement("script");
d.onerror=b;c&&(d.onload=c);g.Yk(d,g.kr(a));(document.head||document.documentElement).appendChild(d)},gTa=function(){var a=g7(),b=[];
if(1<a){var c=a-1;b.push("//www.gstatic.com/eureka/clank/"+a+"/cast_sender.js");b.push("//www.gstatic.com/eureka/clank/"+c+"/cast_sender.js")}return b},i7=function(){var a=dTa();
a&&a(!1,"No cast extension found")},j7=function(){if(hTa){var a=2,b=dTa(),c=function(){a--;
0==a&&b&&b(!0)};
window.__onGCastApiAvailable=c;eTa("//www.gstatic.com/cast/sdk/libs/sender/1.0/cast_framework.js",i7,c)}},iTa=function(){j7();
var a=gTa();a.push("//www.gstatic.com/eureka/clank/cast_sender.js");h7(a)},kTa=function(){j7();
var a=gTa();a.push.apply(a,g.v(jTa.map(fTa)));a.push("//www.gstatic.com/eureka/clank/cast_sender.js");h7(a)},k7=function(a,b,c){g.H.call(this);
...
return g.C.setTimeout(function(){a()},b)},q7=function(a){p7.dispatchEvent(new lTa(p7,a))},lTa=function(a,b){g.ke.call(this,"statevent",a);
this.stat=b},r7=function(a,b,c,d){this.i=a;
this.B=b;this.S=c;this.K=d||1;this.u=45E3;this.C=new g.ek(this);this.I=new g.Bh;this.I.setInterval(250)},nTa=function(a,b,c){a.Ht=1;
a.Tm=O6(b.clone());a.yq=c;a.D=!0;mTa(a,null)},s7=function(a,b,c,d,e){a.Ht=1;
a.Tm=O6(b.clone());a.yq=null;a.D=c;e&&(a.KN=!1);mTa(a,d)},mTa=function(a,b){a.qt=Date.now();
t7(a);a.Co=a.Tm.clone();P6(a.Co,"t",a.K);a.xB=0;a.Mf=a.i.pD(a.i.nx()?b:null);0<a.kC&&(a.LA=new l7((0,g.E)(a.OO,a,a.Mf),a.kC));a.C.Ra(a.Mf,"readystatechange",a.vQ);b=a.Wo?g.Ke(a.Wo):{};a.yq?(a.vB="POST",b["Content-Type"]="application/x-www-form-urlencoded",a.Mf.send(a.Co,a.vB,a.yq,b)):(a.vB="GET",a.KN&&!g.Ig&&(b.Connection="close"),a.Mf.send(a.Co,a.vB,null,b));a.i.xj(1)},pTa=function(a,b){var c=a.xB,d=b.indexOf("\n",c);
if(-1==d)return u7;c=Number(b.substring(c,d));if(isNaN(c))return oTa;d+=1;if(d+c>b.length)return u7;b=b.substr(d,c);a.xB=d+c;return b},rTa=function(a,b){a.qt=Date.now();
t7(a);var c=b?window.location.hostname:"";a.Co=a.Tm.clone();g.Yj(a.Co,"DOMAIN",c);g.Yj(a.Co,"t",a.K);try{a.Nj=new ActiveXObject("htmlfile")}catch(m){v7(a);a.Nm=7;q7(22);w7(a);return}var d="<html><body>";if(b){var e="";for(b=0;b<c.length;b++){var f=c.charAt(b);if("<"==f)f=e+"\\x3c";else if(">"==f)f=e+"\\x3e";else{if(f in x7)f=x7[f];else if(f in qTa)f=x7[f]=qTa[f];else{var h=f.charCodeAt(0);if(31<h&&127>h)var l=f;else{if(256>h){if(l="\\x",16>h||256<h)l+="0"}else l="\\u",4096>h&&(l+="0");l+=h.toString(16).toUpperCase()}f=
...
a.u;
sTa(a,a.u)},sTa=function(a,b){if(null!=a.St)throw Error("WatchDog timer not null");
...
g.he(a.LA);a.LA=null;a.I.stop();g.gk(a.C);if(a.Mf){var b=a.Mf;a.Mf=null;b.abort();b.dispose()}a.Nj&&(a.Nj=null)},z7=function(a,b){try{a.i.MM(a,b),a.i.xj(4)}catch(c){}},uTa=function(a,b,c,d,e){if(0==d)c(!1);
else{var f=e||0;d--;tTa(a,b,function(h){h?c(!0):g.C.setTimeout(function(){uTa(a,b,c,d,f)},f)})}},tTa=function(a,b,c){var d=new Image;
...
DSa(d,a)},A7=function(a){a.onload=null;
a.onerror=null;a.onabort=null;a.ontimeout=null},vTa=function(a){this.i=a;
this.u=new n7},wTa=function(a){var b=B7(a.i,a.Pu,"/mail/images/cleardot.gif");
O6(b);uTa(b.toString(),5E3,(0,g.E)(a.mR,a),3,2E3);a.xj(1)},D7=function(a){var b=a.i.X;
if(null!=b)q7(5),b?(q7(11),C7(a.i,a,!1)):(q7(12),C7(a.i,a,!0));else if(a.oh=new r7(a,void 0,void 0,void 0),a.oh.Wo=a.lC,b=a.i,b=B7(b,b.nx()?a.Au:null,a.mC),q7(5),!g.Cc||g.vc(10))P6(b,"TYPE","xmlhttp"),s7(a.oh,b,!1,a.Au,!1);else{P6(b,"TYPE","html");var c=a.oh;a=!!a.Au;c.Ht=3;c.Tm=O6(b.clone());rTa(c,a)}},E7=function(a,b,c){this.i=1;
this.u=[];this.C=[];this.D=new n7;this.S=a||null;this.X=null!=b?b:null;this.I=c||!1},xTa=function(a,b){this.i=a;
this.map=b;this.context=null},yTa=function(a,b,c,d){g.ke.call(this,"timingevent",a);
this.size=b;this.bx=d},zTa=function(a){g.ke.call(this,"serverreachability",a)},CTa=function(a){ATa(a);
if(3==a.i){var b=a.qw++,c=a.Ry.clone();g.Yj(c,"SID",a.B);g.Yj(c,"RID",b);g.Yj(c,"TYPE","terminate");F7(a,c);b=new r7(a,a.B,b,void 0);b.Ht=2;b.Tm=O6(c.clone());DSa(new Image,b.Tm.toString());b.qt=Date.now();t7(b)}BTa(a)},DTa=function(a){a.MR(1,0);
a.Ry=B7(a,null,a.nC);G7(a)},ATa=function(a){a.Xm&&(a.Xm.abort(),a.Xm=null);
a.Je&&(a.Je.cancel(),a.Je=null);a.Dl&&(g.C.clearTimeout(a.Dl),a.Dl=null);H7(a);a.Wg&&(a.Wg.cancel(),a.Wg=null);a.un&&(g.C.clearTimeout(a.un),a.un=null)},ETa=function(a,b){if(0==a.i)throw Error("Invalid operation: sending map when state is closed");
a.u.push(new xTa(a.pT++,b));2!=a.i&&3!=a.i||G7(a)},FTa=function(a){var b=0;
a.Je&&b++;a.Wg&&b++;return b},G7=function(a){a.Wg||a.un||(a.un=o7((0,g.E)(a.SM,a),0),a.gs=0)},HTa=function(a,b){if(1==a.i){if(!b){a.qw=Math.floor(1E5*Math.random());
b=a.qw++;var c=new r7(a,"",b,void 0);c.Wo=a.Yj;var d=I7(a),e=a.Ry.clone();g.Yj(e,"RID",b);g.Yj(e,"CVER","1");F7(a,e);nTa(c,e,d);a.Wg=c;a.i=2}}else 3==a.i&&(b?GTa(a,b):0==a.u.length||a.Wg||GTa(a))},GTa=function(a,b){if(b)if(6<a.rp){a.u=a.C.concat(a.u);
a.C.length=0;var c=a.qw-1;b=I7(a)}else c=b.S,b=b.yq;else c=a.qw++,b=I7(a);var d=a.Ry.clone();g.Yj(d,"SID",a.B);g.Yj(d,"RID",c);g.Yj(d,"AID",a.Ls);F7(a,d);c=new r7(a,a.B,c,a.gs+1);c.Wo=a.Yj;c.setTimeout(1E4+Math.round(1E4*Math.random()));a.Wg=c;nTa(c,d,b)},F7=function(a,b){a.Nf&&(a=a.Nf.hK())&&g.se(a,function(c,d){g.Yj(b,d,c)})},I7=function(a){var b=Math.min(a.u.length,1E3),c=["count="+b];
...
return c.join("&")},ITa=function(a){a.Je||a.Dl||(a.K=1,a.Dl=o7((0,g.E)(a.RM,a),0),a.Lr=0)},J7=function(a){if(a.Je||a.Dl||3<=a.Lr)return!1;
a.K++;a.Dl=o7((0,g.E)(a.RM,a),JTa(a,a.Lr));a.Lr++;return!0},C7=function(a,b,c){a.tB=c;
a.Zj=b.ql;a.I||DTa(a)},H7=function(a){null!=a.Bp&&(g.C.clearTimeout(a.Bp),a.Bp=null)},JTa=function(a,b){var c=5E3+Math.floor(1E4*Math.random());
a.isActive()||(c*=2);return c*b},K7=function(a,b){if(2==b||9==b){var c=null;
a.Nf&&(c=null);var d=(0,g.E)(a.xX,a);c||(c=new g.Qj("//www.google.com/images/cleardot.gif"),O6(c));tTa(c.toString(),1E4,d)}else q7(2);KTa(a,b)},KTa=function(a,b){a.i=0;
a.Nf&&a.Nf.vJ(b);BTa(a);ATa(a)},BTa=function(a){a.i=0;
...
if(""!=d.i)b&&g.Sj(d,b+"."+d.i),g.Tj(d,d.B);else{var e=window.location;d=LSa(e.protocol,b?b+"."+e.hostname:e.hostname,+e.port,c)}a.xv&&g.se(a.xv,function(f,h){g.Yj(d,h,f)});
g.Yj(d,"VER",a.rp);F7(a,d);return d},LTa=function(){},MTa=function(){this.i=[];
this.u=[]},NTa=function(a,b){this.action=a;
...
e=void 0===e?!1:e;this.va=a;this.I=b;this.B=new g.vr;this.u=new L7(this.bX,this);this.i=null;this.ma=!1;this.D=null;this.X="";this.S=this.C=0;this.K=[];this.Aa=c;this.Z=d;this.Ba=e},OTa=function(a){return{firstTestResults:[""],
secondTestResults:!a.i.tB,sessionId:a.i.B,arrayId:a.i.Ls}},PTa=function(a,b){a.S=b||0;
a.u.stop();N7(a);a.i&&(3==a.i.getState()&&HTa(a.i),CTa(a.i));a.S=0},O7=function(a){return!!a.i&&3==a.i.getState()},N7=function(a){if(a.i){var b=a.Z(),c=a.i.Yj||{};
...
method:"POST",context:a,timeout:5E3,withCredentials:!1,onSuccess:g.Pa(a.C,d,!0),onError:g.Pa(a.B,e),onTimeout:g.Pa(a.D,e)};c&&(a.postParams=c,a.headers={"Content-Type":"application/x-www-form-urlencoded"});return g.Ht(b,a)},TTa=function(){var a=QTa;
RTa();S7.push(a);STa()},T7=function(a,b){RTa();
var c=UTa(a,String(b));g.Tb(S7)?VTa(c):(STa(),g.nc(S7,function(d){d(c)}))},RTa=function(){S7||(S7=g.Ga("yt.mdx.remote.debug.handlers_")||[],g.Fa("yt.mdx.remote.debug.handlers_",S7,void 0))},VTa=function(a){var b=(U7+1)%50;
U7=b;V7[b]=a;W7||(W7=49==b)},STa=function(){var a=S7;
if(V7[0]){var b=W7?U7:-1;do{b=(b+1)%50;var c=V7[b];g.nc(a,function(d){d(c)})}while(b!=U7);
V7=Array(50);U7=-1;W7=!1}},UTa=function(a,b){var c=(Date.now()-WTa)/1E3;
c.toFixed&&(c=c.toFixed(3));var d=[];d.push("[",c+"s","] ");d.push("[","yt.mdx.remote","] ");d.push(a+": "+b,"\n");return d.join("")},X7=function(a){g.Zx.call(this);
this.I=a;this.screens=[]},XTa=function(a,b){var c=a.get(b.uuid)||a.get(b.id);
if(c)return a=c.name,c.id=b.id||c.id,c.name=b.name,c.token=b.token,c.uuid=b.uuid||c.uuid,c.name!=a;a.screens.push(b);return!0},YTa=function(a,b){var c=a.screens.length!=b.length;
a.screens=g.Jo(a.screens,function(f){return!!Z6(b,f)});
for(var d=0,e=b.length;d<e;d++)c=XTa(a,b[d])||c;return c},ZTa=function(a,b){var c=a.screens.length;
...
this.u=a;this.i=NaN;Z7(this);this.info("Initializing with "+X6(this.screens))},$Ta=function(a){if(a.screens.length){var b=g.tm(a.screens,function(d){return d.id}),c=Q7(a.u,"/pairing/get_lounge_token_batch");
R7(a.u,c,{screen_ids:b.join(",")},(0,g.E)(a.jS,a),(0,g.E)(a.iS,a))}},Z7=function(a){if(g.P("deprecate_pair_servlet_enabled"))return YTa(a,[]);
var b=RSa(XSa());b=g.Jo(b,function(c){return!c.uuid});
return YTa(a,b)},a8=function(a,b){ZSa(g.tm(a.screens,PSa));
b&&YSa()},c8=function(a,b){g.Zx.call(this);
...
else{c=g.Ae(b);for(var d=0,e=c.length;d<e;++d)if(!a.i[c[d]]){c=!1;break a}c=!0}c||(b8("Updated online screens: "+g.bi(a.i)),a.i=b,a.ea("screenChange"));aUa(a)},f8=function(a){isNaN(a.B)||g.Bt(a.B);
a.B=g.zt((0,g.E)(a.VF,a),0<a.C&&a.C<g.Qa()?2E4:1E4)},b8=function(a){T7("OnlineScreenService",a)},bUa=function(a){var b={};
g.nc(a.I(),function(c){c.token?b[c.token]=c.id:this.le("Requesting availability of screen w/o lounge token.")});
return b},aUa=function(a){a=g.Ae(g.te(a.i,function(b){return b}));
...
X7.call(this,"ScreenService");this.C=a;this.K=b;this.i=this.u=null;this.B=[];this.D={};cUa(this)},eUa=function(a,b,c,d,e,f){a.info("getAutomaticScreenByIds "+c+" / "+b);
c||(c=a.D[b]);var h=a.Hh(),l=c?$6(h,c):null;c&&(a.K||l)||(l=$6(h,b));if(l){l.uuid=b;var m=h8(a,l);d8(a.i,m,function(n){e(n?m:null)})}else c?dUa(a,c,(0,g.E)(function(n){var p=h8(this,new U6({name:d,
screenId:c,loungeToken:n,dialId:b||""}));d8(this.i,p,function(q){e(q?p:null)})},a),f):e(null)},fUa=function(a,b){for(var c=0,d=a.screens.length;c<d;++c)if(a.screens[c].name==b)return a.screens[c];
return null},gUa=function(a,b,c){d8(a.i,b,c)},dUa=function(a,b,c,d){a.info("requestLoungeToken_ for "+b);
...
g.Ht(Q7(a.C,"/pairing/get_lounge_token_batch"),e)},hUa=function(a){a.screens=a.u.Hh();
var b=a.D,c={},d;for(d in b)c[b[d]]=d;b=0;for(d=a.screens.length;b<d;++b){var e=a.screens[b];e.uuid=c[e.id]||""}a.info("Updated manual screens: "+X6(a.screens))},cUa=function(a){i8(a);
a.u=new $7(a.C);a.u.subscribe("screenChange",(0,g.E)(a.sS,a));hUa(a);a.K||(a.B=RSa(g.Ny("yt-remote-automatic-screen-cache")||[]));i8(a);a.info("Initializing automatic screens: "+X6(a.B));a.i=new c8(a.C,(0,g.E)(a.Hh,a,!0));a.i.subscribe("screenChange",(0,g.E)(function(){this.ea("onlineScreenChange")},a))},h8=function(a,b){var c=a.get(b.id);
c?(c.uuid=b.uuid,b=c):((c=$6(a.B,b.uuid))?(c.id=b.id,c.token=b.token,b=c):a.B.push(b),a.K||iUa(a));i8(a);a.D[b.uuid]=b.id;g.My("yt-remote-device-id-map",a.D,31536E3);return b},iUa=function(a){a=g.Jo(a.B,function(b){return"shortLived"!=b.idType});
g.My("yt-remote-automatic-screen-cache",g.tm(a,PSa))},i8=function(a){a.D=g.Ny("yt-remote-device-id-map")||{}},j8=function(a,b,c){g.Zx.call(this);
this.Ba=c;this.B=a;this.i=b;this.C=null},k8=function(a,b){a.C=b;
a.ea("sessionScreen",a.C)},jUa=function(a,b){a.C&&(a.C.token=b,h8(a.B,a.C));
a.ea("sessionScreen",a.C)},l8=function(a,b){T7(a.Ba,b)},m8=function(a,b,c){j8.call(this,a,b,"CastSession");
var d=this;this.config_=c;this.u=null;this.Z=(0,g.E)(this.AQ,this);this.Aa=(0,g.E)(this.yW,this);this.ma=g.zt(function(){kUa(d,null)},12E4);
this.K=this.D=this.I=this.S=0;this.va=!1;this.X="unknown"},n8=function(a,b){g.Bt(a.K);
a.K=0;0==b?lUa(a):a.K=g.zt(function(){lUa(a)},b)},lUa=function(a){mUa(a,"getLoungeToken");
g.Bt(a.D);a.D=g.zt(function(){nUa(a,null)},3E4)},mUa=function(a,b){a.info("sendYoutubeMessage_: "+b+" "+g.bi(void 0));
var c={};c.type=b;a.u?a.u.sendMessage("urn:x-cast:com.google.youtube.mdx",c,g.Ia,(0,g.E)(function(){l8(this,"Failed to send message: "+b+".")},a)):l8(a,"Sending yt message without session: "+g.bi(c))},o8=function(a,b){b?(a.info("onConnectedScreenId_: Received screenId: "+b),a.getScreen()&&a.getScreen().id==b||a.vK(b,function(c){k8(a,c)},function(){return a.zg()},5)):a.zg(Error("Waiting for session status timed out."))},pUa=function(a,b,c){a.info("onConnectedScreenData_: Received screenData: "+JSON.stringify(b));
var d=new U6(b);oUa(a,d,function(e){e?(a.va=!0,h8(a.B,d),k8(a,d),a.X="unknown",n8(a,c)):(g.Is(Error("CastSession, RemoteScreen from screenData: "+JSON.stringify(b)+" is not online.")),a.zg())},5)},kUa=function(a,b){g.Bt(a.ma);
a.ma=0;b?a.config_.enableCastLoungeToken&&b.loungeToken?b.deviceId?a.getScreen()&&a.getScreen().uuid==b.deviceId||(b.loungeTokenRefreshIntervalMs?pUa(a,{name:a.i.friendlyName,screenId:b.screenId,loungeToken:b.loungeToken,dialId:b.deviceId,screenIdType:"shortLived"},b.loungeTokenRefreshIntervalMs):(g.Is(Error("No loungeTokenRefreshIntervalMs presents in mdxSessionStatusData: "+JSON.stringify(b)+".")),o8(a,b.screenId))):(g.Is(Error("No device id presents in mdxSessionStatusData: "+JSON.stringify(b)+
".")),o8(a,b.screenId)):o8(a,b.screenId):a.zg(Error("Waiting for session status timed out."))},nUa=function(a,b){g.Bt(a.D);
a.D=0;var c=null;if(b)if(b.loungeToken){var d;(null==(d=a.getScreen())?void 0:d.token)==b.loungeToken&&(c="staleLoungeToken")}else c="missingLoungeToken";else c="noLoungeTokenResponse";c?(a.info("Did not receive a new lounge token in onLoungeToken_ with data: "+(JSON.stringify(b)+", error: "+c)),a.X=c,n8(a,3E4)):(jUa(a,b.loungeToken),a.va=!1,a.X="unknown",n8(a,b.loungeTokenRefreshIntervalMs))},oUa=function(a,b,c,d){g.Bt(a.I);
a.I=0;gUa(a.B,b,function(e){e||0>d?c(e):a.I=g.zt(function(){oUa(a,b,c,d-1)},300)})},qUa=function(a){g.Bt(a.S);
...
return!!(a.config_.enableDialLoungeToken&&(null==(b=a.u)?0:b.getDialAppInfo))},rUa=function(a){a.D=a.B.gI(a.Aa,a.i.label,a.i.friendlyName,q8(a),function(b,c){a.D=g.Ia;
a.Z=!0;k8(a,b);"shortLived"==b.idType&&0<c&&r8(a,c)},function(b){a.D=g.Ia;
a.zg(b)})},sUa=function(a){var b={};
b.pairingCode=a.Aa;b.theme=a.Na;bTa()&&(b.env_useStageMdx=1);return g.ui(b)},s8=function(a){return new Promise(function(b){a.Aa=Y6();
if(a.Ka){var c=new chrome.cast.DialLaunchResponse(!0,sUa(a));b(c);rUa(a)}else a.ma=function(){g.Bt(a.X);a.ma=function(){};
a.X=NaN;var d=new chrome.cast.DialLaunchResponse(!0,sUa(a));b(d);rUa(a)},a.X=g.zt(function(){a.ma()},100)})},uUa=function(a,b,c){a.info("initOnConnectedScreenDataPromise_: Received screenData: "+JSON.stringify(b));
var d=new U6(b);return(new Promise(function(e){tUa(a,d,function(f){f?(a.Z=!0,h8(a.B,d),k8(a,d),r8(a,c)):g.Is(Error("DialSession, RemoteScreen from screenData: "+JSON.stringify(b)+" is not online."));e(f)},5)})).then(function(e){return e?new chrome.cast.DialLaunchResponse(!1):s8(a)})},vUa=function(a,b){var c=a.S.receiver.label,d=a.i.friendlyName;
return(new Promise(function(e){eUa(a.B,c,b,d,function(f){f&&f.token&&k8(a,f);e(f)},function(f){l8(a,"Failed to get DIAL screen: "+f);
e(null)})})).then(function(e){return e&&e.token?new chrome.cast.DialLaunchResponse(!1):s8(a)})},tUa=function(a,b,c,d){g.Bt(a.I);
a.I=0;gUa(a.B,b,function(e){e||0>d?c(e):a.I=g.zt(function(){tUa(a,b,c,d-1)},300)})},r8=function(a,b){a.info("getDialAppInfoWithTimeout_ "+b);
q8(a)&&(g.Bt(a.K),a.K=0,0==b?wUa(a):a.K=g.zt(function(){wUa(a)},b))},wUa=function(a){q8(a)&&a.u.getDialAppInfo(function(b){a.info("getDialAppInfo dialLaunchData: "+JSON.stringify(b));
b=b.extraData||{};var c=null;if(b.loungeToken){var d;(null==(d=a.getScreen())?void 0:d.token)==b.loungeToken&&(c="staleLoungeToken")}else c="missingLoungeToken";c?(a.va=c,r8(a,3E4)):(a.Z=!1,a.va="unknown",jUa(a,b.loungeToken),r8(a,b.loungeTokenRefreshIntervalMs))},function(b){a.info("getDialAppInfo error: "+b);
a.va="noLoungeTokenResponse";r8(a,3E4)})},xUa=function(a){g.Bt(a.I);
...
this.config_=b;this.u=a;this.S=b.appId||"233637DE";this.C=b.theme||"cl";this.X=b.disableCastApi||!1;this.I=b.forceMirroring||!1;this.i=null;this.K=!1;this.B=[];this.D=(0,g.E)(this.rV,this)},yUa=function(a,b){return b?g.Nb(a.B,function(c){return V6(b,c.label)},a):null},v8=function(a){T7("Controller",a)},QTa=function(a){window.chrome&&chrome.cast&&chrome.cast.logMessage&&chrome.cast.logMessage(a)},w8=function(a){return a.K||!!a.B.length||!!a.i},x8=function(a,b,c){b!=a.i&&(g.he(a.i),(a.i=b)?(c?a.ea("yt-remote-cast2-receiver-resumed",
b.i):a.ea("yt-remote-cast2-receiver-selected",b.i),b.subscribe("sessionScreen",(0,g.E)(a.QM,a,b)),b.subscribe("sessionFailed",function(){return zUa(a,b)}),b.getScreen()?a.ea("yt-remote-cast2-session-change",b.getScreen()):c&&a.i.Ms(null)):a.ea("yt-remote-cast2-session-change",null))},zUa=function(a,b){a.i==b&&a.ea("yt-remote-cast2-session-failed")},AUa=function(a){var b=a.u.fI(),c=a.i&&a.i.i;
a=g.tm(b,function(d){c&&V6(d,c.label)&&(c=null);var e=d.uuid?d.uuid:d.id,f=yUa(this,d);f?(f.label=e,f.friendlyName=d.name):(f=new chrome.cast.Receiver(e,d.name),f.receiverType=chrome.cast.ReceiverType.CUSTOM);return f},a);
c&&(c.receiverType!=chrome.cast.ReceiverType.CUSTOM&&(c=new chrome.cast.Receiver(c.label,c.friendlyName),c.receiverType=chrome.cast.ReceiverType.CUSTOM),a.push(c));return a},FUa=function(a,b,c,d){d.disableCastApi?y8("Cannot initialize because disabled by Mdx config."):BUa()?CUa(b,d)&&(z8(!0),window.chrome&&chrome.cast&&chrome.cast.isAvailable?DUa(a,c):(window.__onGCastApiAvailable=function(e,f){e?DUa(a,c):(A8("Failed to load cast API: "+f),B8(!1),z8(!1),g.Oy("yt-remote-cast-available"),g.Oy("yt-remote-cast-receiver"),
EUa(),c(!1))},d.loadCastApiSetupScript?g.Qy("https://www.gstatic.com/cv/js/sender/v1/cast_sender.js"):0<=window.navigator.userAgent.indexOf("Android")&&0<=window.navigator.userAgent.indexOf("Chrome/")&&window.navigator.presentation?60<=g7()&&iTa():!window.chrome||!window.navigator.presentation||0<=window.navigator.userAgent.indexOf("Edge")?i7():89<=g7()?kTa():(j7(),h7(jTa.map(fTa))))):y8("Cannot initialize because not running Chrome")},EUa=function(){y8("dispose");
var a=C8();a&&a.dispose();g.Fa("yt.mdx.remote.cloudview.instance_",null,void 0);GUa(!1);g.mv(D8);D8.length=0},E8=function(){return!!g.Ny("yt-remote-cast-installed")},HUa=function(){var a=g.Ny("yt-remote-cast-receiver");
return a?a.friendlyName:null},IUa=function(){y8("clearCurrentReceiver");
g.Oy("yt-remote-cast-receiver")},JUa=function(){return E8()?C8()?C8().getCastSession():(A8("getCastSelector: Cast is not initialized."),null):(A8("getCastSelector: Cast API is not installed!"),null)},G8=function(){E8()?C8()?F8()?(y8("Requesting cast selector."),C8().requestSession()):(y8("Wait for cast API to be ready to request the session."),D8.push(g.lv("yt-remote-cast2-api-ready",G8))):A8("requestCastSelector: Cast is not initialized."):A8("requestCastSelector: Cast API is not installed!")},H8=
function(a,b){F8()?C8().setConnectedScreenStatus(a,b):A8("setConnectedScreenStatus called before ready.")},BUa=function(){var a=0<=g.Bb.search(/ (CrMo|Chrome|CriOS)\//);
return g.Zi||a},KUa=function(a,b){C8().init(a,b)},CUa=function(a,b){var c=!1;
...
y8("cloudview.createSingleton_: "+c);return c},C8=function(){return g.Ga("yt.mdx.remote.cloudview.instance_")},DUa=function(a,b){B8(!0);
z8(!1);KUa(a,function(c){c?(GUa(!0),g.nv("yt-remote-cast2-api-ready")):(A8("Failed to initialize cast API."),B8(!1),g.Oy("yt-remote-cast-available"),g.Oy("yt-remote-cast-receiver"),EUa());b(c)})},y8=function(a){T7("cloudview",a)},A8=function(a){T7("cloudview",a)},B8=function(a){y8("setCastInstalled_ "+a);
g.My("yt-remote-cast-installed",a)},F8=function(){return!!g.Ga("yt.mdx.remote.cloudview.apiReady_")},GUa=function(a){y8("setApiReady_ "+a);
...
this.B=0;this.C=a;this.I=[];this.D=new MTa;this.u=this.i=null;this.X=(0,g.E)(this.aU,this);this.K=(0,g.E)(this.Bw,this);this.S=(0,g.E)(this.ZT,this);this.ma=(0,g.E)(this.hU,this);var c=0;a?(c=a.getProxyState(),3!=c&&(a.subscribe("proxyStateChange",this.mG,this),LUa(this))):c=3;0!=c&&(b?this.mG(c):g.zt((0,g.E)(function(){this.mG(c)},this),0));
(a=JUa())&&P8(this,a);this.subscribe("yt-remote-cast2-session-change",this.ma)},R8=function(a){return new I8(a.C.getPlayerContextData())},LUa=function(a){g.nc("nowAutoplaying autoplayDismissed remotePlayerChange remoteQueueChange autoplayModeChange autoplayUpNext previousNextChange multiStateLoopEnabled loopModeChange".split(" "),function(b){this.I.push(this.C.subscribe(b,g.Pa(this.pV,b),this))},a)},MUa=function(a){g.nc(a.I,function(b){this.C.unsubscribeByKey(b)},a);
...
L8(d,c);-1E3!=d.playerState&&(d.playerState=b);U8(a,d)},W8=function(a,b,c){a.C.sendMessage(b,c)},U8=function(a,b){MUa(a);
a.C.setPlayerContextData(O8(b));LUa(a)},P8=function(a,b){a.u&&(a.u.removeUpdateListener(a.X),a.u.removeMediaListener(a.K),a.Bw(null));
a.u=b;a.u&&(T7("CP","Setting cast session: "+a.u.sessionId),a.u.addUpdateListener(a.X),a.u.addMediaListener(a.K),a.u.media.length&&a.Bw(a.u.media[0]))},NUa=function(a){var b=a.i.media,c=a.i.customData;
...
g.Zx.call(this);this.D=NaN;this.va=!1;this.S=this.K=this.ma=this.Z=NaN;this.X=[];this.C=this.I=this.B=this.fc=this.i=null;this.Ia=a;this.Ba=d;this.X.push(g.Fu(window,"beforeunload",(0,g.E)(this.eS,this)));this.u=[];this.fc=new I8;this.Ka=b.id;this.Aa=b.idType;this.i=OUa(this,c);this.i.subscribe("handlerOpened",this.eU,this);this.i.subscribe("handlerClosed",this.bU,this);this.i.subscribe("handlerError",this.cU,this);this.i.subscribe("handlerMessage",this.dU,this);this.i.XA(b.token);this.subscribe("remoteQueueChange",
function(){var e=this.fc.videoId;g.Py()&&g.My("yt-remote-session-video-id",e)},this)},PUa=function(a){return g.Nb(a.u,function(b){return"LOUNGE_SCREEN"==b.type})},Z8=function(a){T7("conn",a)},OUa=function(a,b){return new M7(Q7(a.Ia,"/bc"),b,!1,function(){return a.kI()},"shortLived"==a.Aa)},$8=function(a,b){a.ea("proxyStateChange",b)},QUa=function(a){a.D=g.zt((0,g.E)(function(){Z8("Connecting timeout");
this.Xr(1)},a),2E4)},a9=function(a){g.Bt(a.D);
a.D=NaN},b9=function(a){g.Bt(a.Z);
a.Z=NaN},RUa=function(a){c9(a);
a.ma=g.zt((0,g.E)(function(){d9(this,"getNowPlaying")},a),2E4)},c9=function(a){g.Bt(a.ma);
a.ma=NaN},TUa=function(a,b){var c=null;
if(b){var d=PUa(a);d&&(c={clientName:d.clientName,deviceMake:d.brand,deviceModel:d.model,osVersion:d.osVersion})}g.Fa("yt.mdx.remote.remoteClient_",c,void 0);b&&(a9(a),b9(a));c=O7(a.i)&&isNaN(a.D);b==c?b&&($8(a,1),d9(a,"getSubtitlesTrack")):b?(a.uK()&&a.fc.reset(),$8(a,1),d9(a,"getNowPlaying"),SUa(a)):a.Xr(1)},UUa=function(a,b){var c=b.params.videoId;
delete b.params.videoId;c==a.fc.videoId&&(g.Ge(b.params)?a.fc.trackData=null:a.fc.trackData=b.params,a.ea("remotePlayerChange"))},VUa=function(a,b){var c=b.params.videoId||b.params.video_id,d=parseInt(b.params.currentIndex,10);
a.fc.listId=b.params.listId||a.fc.listId;N8(a.fc,c,d);a.ea("remoteQueueChange")},XUa=function(a,b){b.params=b.params||{};
VUa(a,b);WUa(a,b);a.ea("autoplayDismissed")},WUa=function(a,b){var c=parseInt(b.params.currentTime||b.params.current_time,10);
L8(a.fc,isNaN(c)?0:c);c=parseInt(b.params.state,10);c=isNaN(c)?-1:c;-1==c&&-1E3==a.fc.playerState&&(c=-1E3);a.fc.playerState=c;c=Number(b.params.loadedTime);a.fc.S=isNaN(c)?0:c;a.fc.Ij(Number(b.params.duration));c=a.fc;var d=Number(b.params.liveIngestionTime);c.B=d;c.u=isNaN(d)?!1:!0;c=a.fc;d=Number(b.params.seekableStartTime);b=Number(b.params.seekableEndTime);c.C=isNaN(d)?0:d;c.i=isNaN(b)?0:b;1==a.fc.playerState?RUa(a):c9(a);a.ea("remotePlayerChange")},YUa=function(a,b){if(-1E3!=a.fc.playerState){var c=
1085;
switch(parseInt(b.params.adState,10)){case 1:c=1081;break;case 2:c=1084;break;case 0:c=1083}a.fc.playerState=c;b=parseInt(b.params.currentTime,10);L8(a.fc,isNaN(b)?0:b);a.ea("remotePlayerChange")}},ZUa=function(a,b){var c="true"==b.params.muted;
a.fc.volume=parseInt(b.params.volume,10);a.fc.muted=c;a.ea("remotePlayerChange")},$Ua=function(a,b){a.I=b.params.videoId;
a.ea("nowAutoplaying",parseInt(b.params.timeout,10))},aVa=function(a,b){var c="true"==b.params.hasNext;
a.fc.Gk="true"==b.params.hasPrevious;a.fc.hasNext=c;a.ea("previousNextChange")},SUa=function(a){g.Bt(a.S);
...
this.Se=a;this.i=[];this.i.push(this.Se.$_s("screenChange",(0,g.E)(this.FQ,this)));this.i.push(this.Se.$_s("onlineScreenChange",(0,g.E)(this.WU,this)))},eVa=function(a,b){aTa();
if(!f7||!f7.get("yt-remote-disable-remote-module-for-dev")){b=g.O("MDX_CONFIG")||b;TSa();d7();f9||(f9=new P7(b?b.loungeApiHost:void 0),bTa()&&(f9.i="/api/loungedev"));g9||(g9=g.Ga("yt.mdx.remote.deferredProxies_")||[],g.Fa("yt.mdx.remote.deferredProxies_",g9,void 0));bVa();var c=h9();if(!c){var d=new g8(f9,b?b.disableAutomaticScreenCache||!1:!1);g.Fa("yt.mdx.remote.screenService_",d,void 0);c=h9();var e={};b&&(e={appId:b.appId,disableDial:b.disableDial,theme:b.theme,loadCastApiSetupScript:b.loadCastApiSetupScript,
disableCastApi:b.disableCastApi,enableDialLoungeToken:b.enableDialLoungeToken,enableCastLoungeToken:b.enableCastLoungeToken,forceMirroring:b.forceMirroring});g.Fa("yt.mdx.remote.enableConnectWithInitialState_",b?b.enableConnectWithInitialState||!1:!1,void 0);FUa(a,d,function(f){f?i9()&&H8(i9(),"YouTube TV"):d.subscribe("onlineScreenChange",function(){S6("yt-remote-receiver-availability-change")})},e)}b&&!g.Ga("yt.mdx.remote.initialized_")&&(g.Fa("yt.mdx.remote.initialized_",!0,void 0),j9("Initializing: "+
...
S6("yt-remote-auto-connect","cast-selector-receiver")})),k9.push(g.lv("yt-remote-cast2-receiver-resumed",function(){S6("yt-remote-receiver-resumed","cast-selector-receiver")})),k9.push(g.lv("yt-remote-cast2-session-change",cVa)),k9.push(g.lv("yt-remote-connection-change",function(f){f?H8(i9(),"YouTube TV"):m9()||(H8(null,null),IUa())})),k9.push(g.lv("yt-remote-cast2-session-failed",function(){S6("yt-remote-connection-failed")})),a=n9(),b.isAuto&&(a.id+="#dial"),e=b.capabilities||[],g.P("desktop_enable_autoplay")&&
e.push("atp"),0<e.length&&(a.capabilities=e),a.name=b.device,a.app=b.app,(b=b.theme)&&(a.theme=b),j9(" -- with channel params: "+g.bi(a)),a?(g.My("yt-remote-session-app",a.app),g.My("yt-remote-session-name",a.name)):(g.Oy("yt-remote-session-app"),g.Oy("yt-remote-session-name")),g.Fa("yt.mdx.remote.channelParams_",a,void 0),c.start(),i9()||dVa())}},fVa=function(){var a=h9().Se.$_gos();
var b=o9();b&&p9()&&(Z6(a,b)||a.push(b));return SSa(a)},q9=function(){var a=gVa();
!a&&E8()&&HUa()&&(a={key:"cast-selector-receiver",name:HUa()});return a},gVa=function(){var a=fVa(),b=o9();
b||(b=m9());return g.Nb(a,function(c){return b&&V6(b,c.key)?!0:!1})},o9=function(){var a=i9();
if(!a)return null;var b=h9().Hh();return $6(b,a)},cVa=function(a){j9("remote.onCastSessionChange_: "+W6(a));
...
o9()&&o9();if(x9)r9=a;else{hVa(a.id);var c=g.Ga("yt.mdx.remote.enableConnectWithInitialState_")||!1;a=new Y8(f9,a,n9(),c);a.connect(b,iVa());a.subscribe("beforeDisconnect",function(d){S6("yt-remote-before-disconnect",d)});
...
u9(a)}},dVa=function(){var a=m9();
a?(j9("Resume connection to: "+W6(a)),t9(a,0)):(e7(),IUa(),j9("Skipping connecting because no session screen found."))},bVa=function(){var a=n9();
...
var d=this;this.u=a;this.J=b;this.Sb=c;this.events=new g.iD(this);this.ma=this.events.T(this.J,"onVolumeChange",function(e){jVa(d,e)});
...
a=this.Sb;a.isDisposed();a.subscribe("proxyStateChange",this.LM,this);a.subscribe("remotePlayerChange",this.Fw,this);a.subscribe("remoteQueueChange",this.qA,this);a.subscribe("previousNextChange",this.IM,this);a.subscribe("nowAutoplaying",this.CM,this);a.subscribe("autoplayDismissed",this.fM,this);g.I(this,this.i);g.I(this,this.B);g.I(this,this.S);g.I(this,this.X);g.I(this,this.K);this.dO();this.qA();this.Fw()},jVa=function(a,b){if(z9(a)){a.Sb.unsubscribe("remotePlayerChange",a.Fw,a);
var c=Math.round(b.volume);b=!!b.muted;var d=R8(a.Sb);if(c!==d.volume||b!==d.muted)a.Sb.setVolume(c,b),a.X.start();a.Sb.subscribe("remotePlayerChange",a.Fw,a)}},kVa=function(a){a.Wb(0);
...
if(null===c||void 0===c?0:c.listId){var d=c.index;var e=c.listId.toString()}c=a.J.getVideoData(1);a.Sb.playVideo(c.videoId,b,d,e,c.playerParams,c.Za,ISa(c));a.Tb(new g.NJ(1))},lVa=function(a,b){if(b){var c=a.J.getOption("captions","tracklist",{SK:1});
...
L:"ytp-mdx-popup-dialog",W:{role:"dialog"},U:[{G:"div",L:"ytp-mdx-popup-dialog-inner-content",U:[{G:"div",L:"ytp-mdx-popup-title",ya:"\u30ed\u30b0\u30a2\u30a6\u30c8\u3057\u307e\u3057\u305f"},{G:"div",L:"ytp-mdx-popup-description",ya:"\u8996\u8074\u3057\u305f\u52d5\u753b\u306f\u30c6\u30ec\u30d3\u306e\u518d\u751f\u5c65\u6b74\u306b\u8ffd\u52a0\u3055\u308c\u3001\u30c6\u30ec\u30d3\u306e\u304a\u3059\u3059\u3081\u306b\u5f71\u97ff\u3059\u308b\u53ef\u80fd\u6027\u304c\u3042\u308a\u307e\u3059\u3002\u3053\u308c\u3092\u907f\u3051\u308b\u306b\u306f\u3001\u30ad\u30e3\u30f3\u30bb\u30eb\u3057\u3066\u30d1\u30bd\u30b3\u30f3\u304b\u3089\u30ed\u30b0\u30a4\u30f3\u3057\u307e\u3059\u3002"},
{G:"div",L:"ytp-mdx-privacy-popup-buttons",U:[{G:"button",Ga:["ytp-button","ytp-mdx-privacy-popup-cancel"],ya:"\u30ad\u30e3\u30f3\u30bb\u30eb"},{G:"button",Ga:["ytp-button","ytp-mdx-privacy-popup-confirm"],ya:"\u78ba\u8a8d"}]}]}]});this.i=new g.sL(this,250);this.cancelButton=this.Fa("ytp-mdx-privacy-popup-cancel");this.confirmButton=this.Fa("ytp-mdx-privacy-popup-confirm");g.I(this,this.i);this.T(this.cancelButton,"click",this.u);this.T(this.confirmButton,"click",this.B)},D9=function(a){g.W.call(this,
{G:"div",
L:"ytp-remote",U:[{G:"div",L:"ytp-remote-display-status",U:[{G:"div",L:"ytp-remote-display-status-icon",U:[g.tta()]},{G:"div",L:"ytp-remote-display-status-text",ya:"{{statustext}}"}]}]});this.api=a;this.i=new g.sL(this,250);g.I(this,this.i);this.T(a,"presentingplayerstatechange",this.onStateChange);mVa(this,a.zb())},mVa=function(a,b){if(3===a.api.getPresentingPlayerType()){var c={RECEIVER_NAME:a.api.getOption("remote","currentReceiver").name};
b=g.T(b,128)?g.lI("$RECEIVER_NAME \u3067\u30a8\u30e9\u30fc\u304c\u767a\u751f\u3057\u307e\u3057\u305f",c):b.Dc()||g.T(b,4)?g.lI("$RECEIVER_NAME \u3067\u518d\u751f\u3057\u3066\u3044\u307e\u3059",c):g.lI("$RECEIVER_NAME \u306b\u63a5\u7d9a\u3057\u307e\u3057\u305f",c);a.Sa("statustext",b);a.i.show()}else a.i.hide()},E9=function(a,b){g.MP.call(this,"\u518d\u751f\u30c7\u30d0\u30a4\u30b9",0,a,b);
...
n7.prototype.parse=function(a){return g.C.JSON.parse(a,void 0)};var p7=new g.ef;g.w(lTa,g.ke);g.k=r7.prototype;g.k.Wo=null;g.k.Em=!1;g.k.St=null;g.k.eH=null;g.k.qt=null;g.k.Ht=null;g.k.Tm=null;g.k.Co=null;g.k.yq=null;g.k.Mf=null;g.k.xB=0;g.k.Nj=null;g.k.vB=null;g.k.Nm=null;g.k.yu=-1;g.k.KN=!0;g.k.qp=!1;g.k.kC=0;g.k.LA=null;var oTa={},u7={};g.k=r7.prototype;g.k.setTimeout=function(a){this.u=a};
g.k.vQ=function(a){a=a.target;var b=this.LA;b&&3==g.Ji(a)?b.eI():this.OO(a)};
g.k.OO=function(a){try{if(a==this.Mf)a:{var b=g.Ji(this.Mf),c=this.Mf.u,d=this.Mf.getStatus();if(g.Cc&&!g.vc(10)||g.Ig&&!g.uc("420+")){if(4>b)break a}else if(3>b||3==b&&!g.Oi(this.Mf))break a;this.qp||4!=b||7==c||(8==c||0>=d?this.i.xj(3):this.i.xj(2));y7(this);var e=this.Mf.getStatus();this.yu=e;var f=g.Oi(this.Mf);if(this.Em=200==e){4==b&&v7(this);if(this.D){for(a=!0;!this.qp&&this.xB<f.length;){var h=pTa(this,f);if(h==u7){4==b&&(this.Nm=4,q7(15),a=!1);break}else if(h==oTa){this.Nm=4;q7(16);a=!1;
...
g.k.uW=function(){this.St=null;var a=Date.now();0<=a-this.eH?(2!=this.Ht&&this.i.xj(3),v7(this),this.Nm=2,q7(18),w7(this)):sTa(this,this.eH-a)};
g.k.getLastError=function(){return this.Nm};g.k=vTa.prototype;g.k.lC=null;g.k.oh=null;g.k.MA=!1;g.k.YN=null;g.k.Qy=null;g.k.HE=null;g.k.mC=null;g.k.Zh=null;g.k.ql=-1;g.k.Au=null;g.k.Pu=null;g.k.connect=function(a){this.mC=a;a=B7(this.i,null,this.mC);q7(3);this.YN=Date.now();var b=this.i.S;null!=b?(this.Au=b[0],(this.Pu=b[1])?(this.Zh=1,wTa(this)):(this.Zh=2,D7(this))):(P6(a,"MODE","init"),this.oh=new r7(this,void 0,void 0,void 0),this.oh.Wo=this.lC,s7(this.oh,a,!1,null,!0),this.Zh=0)};
...
g.k.Xx=function(){this.ql=this.oh.yu;if(this.oh.Em)0==this.Zh?this.Pu?(this.Zh=1,wTa(this)):(this.Zh=2,D7(this)):2==this.Zh&&((!g.Cc||g.vc(10)?!this.MA:200>this.HE-this.Qy)?(q7(11),C7(this.i,this,!1)):(q7(12),C7(this.i,this,!0)));else{0==this.Zh?q7(9):2==this.Zh&&q7(10);var a=this.i;this.oh.getLastError();a.Zj=this.ql;K7(a,2)}};
g.k.nx=function(){return this.i.nx()};
g.k.isActive=function(){return this.i.isActive()};
g.k.xj=function(a){this.i.xj(a)};g.k=E7.prototype;g.k.Yj=null;g.k.xv=null;g.k.Wg=null;g.k.Je=null;g.k.nC=null;g.k.Ry=null;g.k.fJ=null;g.k.Yx=null;g.k.qw=0;g.k.pT=0;g.k.Nf=null;g.k.un=null;g.k.Dl=null;g.k.Bp=null;g.k.Xm=null;g.k.tB=null;g.k.Ls=-1;g.k.uL=-1;g.k.Zj=-1;g.k.gs=0;g.k.Lr=0;g.k.rp=8;g.Ra(yTa,g.ke);g.Ra(zTa,g.ke);g.k=E7.prototype;g.k.connect=function(a,b,c,d,e){q7(0);this.nC=b;this.xv=c||{};d&&void 0!==e&&(this.xv.OSID=d,this.xv.OAID=e);this.I?(o7((0,g.E)(this.BJ,this,a),100),DTa(this)):this.BJ(a)};
g.k.BJ=function(a){this.Xm=new vTa(this);this.Xm.lC=this.Yj;this.Xm.u=this.D;this.Xm.connect(a)};
g.k.qf=function(){return 0==this.i};
g.k.getState=function(){return this.i};
g.k.SM=function(a){this.un=null;HTa(this,a)};
g.k.RM=function(){this.Dl=null;this.Je=new r7(this,this.B,"rpc",this.K);this.Je.Wo=this.Yj;this.Je.kC=0;var a=this.fJ.clone();g.Yj(a,"RID","rpc");g.Yj(a,"SID",this.B);g.Yj(a,"CI",this.tB?"0":"1");g.Yj(a,"AID",this.Ls);F7(this,a);if(!g.Cc||g.vc(10))g.Yj(a,"TYPE","xmlhttp"),s7(this.Je,a,!0,this.Yx,!1);else{g.Yj(a,"TYPE","html");var b=this.Je,c=!!this.Yx;b.Ht=3;b.Tm=O6(a.clone());rTa(b,c)}};
...
a&&H7(this),!g.lb(b))for(a=this.D.parse(b),b=0;b<a.length;b++)c=a[b],this.Ls=c[0],c=c[1],2==this.i?"c"==c[0]?(this.B=c[1],this.Yx=c[2],c=c[3],null!=c?this.rp=c:this.rp=6,this.i=3,this.Nf&&this.Nf.xJ(),this.fJ=B7(this,this.nx()?this.Yx:null,this.nC),ITa(this)):"stop"==c[0]&&K7(this,7):3==this.i&&("stop"==c[0]?K7(this,7):"noop"!=c[0]&&this.Nf&&this.Nf.wJ(c),this.Lr=0)};
g.k.ST=function(){null!=this.Bp&&(this.Bp=null,this.Je.cancel(),this.Je=null,J7(this),q7(20))};
g.k.Xx=function(a){if(this.Je==a){H7(this);this.Je=null;var b=2}else if(this.Wg==a)this.Wg=null,b=1;else return;this.Zj=a.yu;if(0!=this.i)if(a.Em)if(1==b){b=Date.now()-a.qt;var c=p7;c.dispatchEvent(new yTa(c,a.yq?a.yq.length:0,b,this.gs));G7(this);this.C.length=0}else ITa(this);else{c=a.getLastError();var d;if(!(d=3==c||7==c||0==c&&0<this.Zj)){if(d=1==b)this.Wg||this.un||1==this.i||2<=this.gs?d=!1:(this.un=o7((0,g.E)(this.SM,this,a),JTa(this,this.gs)),this.gs++,d=!0);d=!(d||2==b&&J7(this))}if(d)switch(c){case 1:K7(this,
...
g.k.xX=function(a){a?q7(2):(q7(1),KTa(this,8))};
...
g.k.xj=function(a){var b=p7;b.dispatchEvent(new zTa(b,a))};
g.k.nx=function(){return!(!g.Cc||g.vc(10))};
g.k=LTa.prototype;g.k.xJ=function(){};
g.k.wJ=function(){};
g.k.vJ=function(){};
g.k.cD=function(){};
g.k.hK=function(){return{}};
g.k.isActive=function(){return!0};g.k=MTa.prototype;g.k.isEmpty=function(){return 0===this.i.length&&0===this.u.length};
...
g.k.isActive=function(){return this.i.isActive()};
g.k.reset=function(){this.i.stop();this.Tf=5E3};g.Ra(M7,LTa);g.k=M7.prototype;g.k.subscribe=function(a,b,c){return this.B.subscribe(a,b,c)};
...
g.k.dispose=function(){this.ma||(this.ma=!0,g.he(this.B),PTa(this),g.he(this.u),this.u=null,this.Z=function(){return""})};
g.k.isDisposed=function(){return this.ma};
g.k.connect=function(a,b,c){if(!this.i||2!=this.i.getState()){this.X="";this.u.stop();this.D=a||null;this.C=b||0;a=this.va+"/test";b=this.va+"/bind";var d=new E7(c?c.firstTestResults:null,c?c.secondTestResults:null,this.Aa),e=this.i;e&&(e.Nf=null);d.Nf=this;this.i=d;N7(this);if(this.i){d=g.O("ID_TOKEN");var f=this.i.Yj||{};d?f["x-youtube-identity-token"]=d:delete f["x-youtube-identity-token"];this.i.Yj=f}e?(3!=e.getState()&&0==FTa(e)||e.getState(),this.i.connect(a,b,this.I,e.B,e.Ls)):c?this.i.connect(a,
b,this.I,c.sessionId,c.arrayId):this.i.connect(a,b,this.I)}};
g.k.sendMessage=function(a,b){a={_sc:a};b&&g.Ne(a,b);this.u.isActive()||2==(this.i?this.i.getState():0)?this.K.push(a):O7(this)&&(N7(this),ETa(this.i,a))};
g.k.xJ=function(){this.u.reset();this.D=null;this.C=0;if(this.K.length){var a=this.K;this.K=[];for(var b=0,c=a.length;b<c;++b)ETa(this.i,a[b])}this.ea("handlerOpened")};
...
g.k.wJ=function(a){"S"==a[0]?this.X=a[1]:"gracefulReconnect"==a[0]?(this.u.start(),CTa(this.i)):this.ea("handlerMessage",new NTa(a[0],a[1]))};
...
g.k.bX=function(){this.u.isActive();0==FTa(this.i)&&this.connect(this.D,this.C)};P7.prototype.C=function(a,b,c,d){b?a(d):a({text:c.responseText})};
P7.prototype.B=function(a,b){a(Error("Request error: "+b.status))};
P7.prototype.D=function(a){a(Error("request timed out"))};var WTa=Date.now(),S7=null,V7=Array(50),U7=-1,W7=!1;g.Ra(X7,g.Zx);X7.prototype.Hh=function(){return this.screens};
...
g.k.wQ=function(a){this.i=null;a.status&&404==a.status?this.u>=pVa.length?this.ea("pairingFailed",Error("DIAL polling timed out")):(a=pVa[this.u],this.Lb=g.zt((0,g.E)(this.eN,this),a),this.u++):this.ea("pairingFailed",Error("Server error "+a.status))};
g.k.yQ=function(){this.i=null;this.ea("pairingFailed",Error("Server not responding"))};
var pVa=[2E3,2E3,1E3,1E3,1E3,2E3,2E3,5E3,5E3,1E4];g.Ra($7,X7);g.k=$7.prototype;g.k.start=function(){Z7(this)&&this.ea("screenChange");!g.Ny("yt-remote-lounge-token-expiration")&&$Ta(this);g.Bt(this.i);this.i=g.zt((0,g.E)(this.start,this),1E4)};
g.k.add=function(a,b){Z7(this);XTa(this,a);a8(this,!1);this.ea("screenChange");b(a);a.token||$Ta(this)};
g.k.remove=function(a,b){var c=Z7(this);ZTa(this,a)&&(a8(this,!1),c=!0);b(a);c&&this.ea("screenChange")};
...
g.k.VF=function(){g.Bt(this.B);this.B=NaN;this.u&&this.u.abort();var a=bUa(this);if(Q6(a)){var b=Q7(this.D,"/pairing/get_screen_availability");this.u=R7(this.D,b,{lounge_token:g.Ae(a).join(",")},(0,g.E)(this.LV,this,a),(0,g.E)(this.KV,this))}else e8(this,{}),f8(this)};
g.k.LV=function(a,b){this.u=null;var c=g.Ae(bUa(this));if(g.lc(c,g.Ae(a))){b=b.screens||[];c={};for(var d=0,e=b.length;d<e;++d)c[a[b[d].loungeToken]]="online"==b[d].status;e8(this,c);f8(this)}else this.le("Changing Screen set during request."),this.VF()};
...
g.k.zQ=function(a,b,c,d){g.Ht(Q7(this.C,"/pairing/get_screen"),{method:"POST",postParams:{pairing_code:a},timeout:5E3,onSuccess:(0,g.E)(function(e,f){e=new U6(f.screen||{});if(!e.name||fUa(this,e.name)){a:{f=e.name;for(var h=2,l=b(f,h);fUa(this,l);){h++;if(20<h)break a;l=b(f,h)}f=l}e.name=f}c(h8(this,e))},this),
...
g.k.sS=function(){hUa(this);this.ea("screenChange");this.i.update()};
...
g.k.xa=function(){this.lG("");j8.ke.xa.call(this)};g.w(m8,j8);g.k=m8.prototype;g.k.kG=function(a){if(this.u){if(this.u==a)return;l8(this,"Overriding cast session with new session object");qUa(this);this.va=!1;this.X="unknown";this.u.removeUpdateListener(this.Z);this.u.removeMessageListener("urn:x-cast:com.google.youtube.mdx",this.Aa)}this.u=a;this.u.addUpdateListener(this.Z);this.u.addMessageListener("urn:x-cast:com.google.youtube.mdx",this.Aa);mUa(this,"getMdxSessionStatus")};
...
g.k.lG=function(){};
g.k.xa=function(){this.info("disposeInternal");qUa(this);this.u&&(this.u.removeUpdateListener(this.Z),this.u.removeMessageListener("urn:x-cast:com.google.youtube.mdx",this.Aa));this.u=null;j8.prototype.xa.call(this)};
g.k.yW=function(a,b){if(!this.isDisposed())if(b)if(b=R6(b),g.Ma(b))switch(a=""+b.type,b=b.data||{},this.info("onYoutubeMessage_: "+a+" "+g.bi(b)),a){case "mdxSessionStatus":kUa(this,b);break;case "loungeToken":nUa(this,b);break;default:l8(this,"Unknown youtube message: "+a)}else l8(this,"Unable to parse message.");else l8(this,"No data in message.")};
g.k.vK=function(a,b,c,d){g.Bt(this.S);this.S=0;eUa(this.B,this.i.label,a,this.i.friendlyName,(0,g.E)(function(e){e?b(e):0<=d?(l8(this,"Screen "+a+" appears to be offline. "+d+" retries left."),this.S=g.zt((0,g.E)(this.vK,this,a,b,c,d-1),300)):c(Error("Unable to fetch screen."))},this),c)};
...
g.k.stop=function(){xUa(this);this.u?this.u.stop((0,g.E)(this.zg,this,null),(0,g.E)(this.zg,this,"Failed to stop DIAL device.")):this.zg()};
g.k.xa=function(){xUa(this);this.u&&this.u.removeUpdateListener(this.Ia);this.u=null;j8.prototype.xa.call(this)};
...
chrome.cast.initialize(c,(0,g.E)(function(){this.isDisposed()||(chrome.cast.addReceiverActionListener(this.D),TTa(),this.u.subscribe("onlineScreenChange",(0,g.E)(this.iI,this)),this.B=AUa(this),chrome.cast.setCustomReceivers(this.B,g.Ia,(0,g.E)(function(f){this.le("Failed to set initial custom receivers: "+g.bi(f))},this)),this.ea("yt-remote-cast2-availability-change",w8(this)),b(!0))},this),(0,g.E)(function(f){this.le("Failed to initialize API: "+g.bi(f));
b(!1)},this))};
g.k.gX=function(a,b){v8("Setting connected screen ID: "+a+" -> "+b);if(this.i){var c=this.i.getScreen();if(!a||c&&c.id!=a)v8("Unsetting old screen status: "+this.i.i.friendlyName),x8(this,null)}if(a&&b){if(!this.i){c=$6(this.u.Hh(),a);if(!c){v8("setConnectedScreenStatus: Unknown screen.");return}if("shortLived"==c.idType){v8("setConnectedScreenStatus: Screen with id type to be short lived.");return}a=yUa(this,c);a||(v8("setConnectedScreenStatus: Connected receiver not custom..."),a=new chrome.cast.Receiver(c.uuid?
...
g.k.xa=function(){this.u.unsubscribe("onlineScreenChange",(0,g.E)(this.iI,this));window.chrome&&chrome.cast&&chrome.cast.removeReceiverActionListener(this.D);var a=QTa,b=g.Ga("yt.mdx.remote.debug.handlers_");g.Wb(b||[],a);g.he(this.i);g.Zx.prototype.xa.call(this)};
...
this.ea("yt-remote-cast2-session-change",this.i.getScreen()),Promise.resolve(new chrome.cast.DialLaunchResponse(!1));this.le('Changing CAST intent from "'+c.receiverType+'" to "dial" for '+b.friendlyName);x8(this,new p8(this.u,b,this.C,this.config_))}b=this.i;b.S=a;b.S.appState==chrome.cast.DialAppState.RUNNING?(a=b.S.extraData||{},c=a.screenId||null,q8(b)&&a.loungeToken?a.loungeTokenRefreshIntervalMs?a=uUa(b,{name:b.i.friendlyName,screenId:a.screenId,loungeToken:a.loungeToken,dialId:b.S.receiver.label,
screenIdType:"shortLived"},a.loungeTokenRefreshIntervalMs):(g.Is(Error("No loungeTokenRefreshIntervalMs presents in additionalData: "+JSON.stringify(a)+".")),a=vUa(b,c)):a=vUa(b,c)):a=s8(b);return a};
...
g.k.iI=function(){this.isDisposed()||(this.B=AUa(this),v8("Updating custom receivers: "+g.bi(this.B)),chrome.cast.setCustomReceivers(this.B,g.Ia,(0,g.E)(function(){this.le("Failed to set custom receivers.")},this)),this.ea("yt-remote-cast2-availability-change",w8(this)))};
...
g.k.xa=function(){MUa(this);this.C=null;this.D.clear();P8(this,null);g.Zx.prototype.xa.call(this)};
...
g.k.Bw=function(a){T7("CP","Cast media: "+!!a);this.i&&this.i.removeUpdateListener(this.S);if(this.i=a)this.i.addUpdateListener(this.S),NUa(this),this.ea("remotePlayerChange")};
g.k.ZT=function(a){a?(NUa(this),this.ea("remotePlayerChange")):this.Bw(null)};
g.k.HG=function(){W8(this,"sendDebugCommand",{debugCommand:"stats4nerds "})};
g.k.hU=function(){var a=JUa();a&&P8(this,a)};
...
n);this.C="UNSUPPORTED";c=this.Ba?"setInitialState":"setPlaylist";Z8("Connecting with "+c+" and params: "+g.bi(m));this.i.connect({method:c,params:g.bi(m)},a,WSa())}else Z8("Connecting without params"),this.i.connect({},a,WSa());QUa(this)};
...
TUa(this,a);a=this.fL("mlm");this.ea("multiStateLoopEnabled",a);break;case "loungeScreenDisconnected":g.Xb(this.u,function(c){return"LOUNGE_SCREEN"==c.type});
TUa(this,!1);break;case "remoteConnected":var b=new T6(R6(a.params.device));g.Nb(this.u,function(c){return b?c.id==b.id:!1})||JSa(this.u,b);
break;case "remoteDisconnected":b=new T6(R6(a.params.device));g.Xb(this.u,function(c){return b?c.id==b.id:!1});
break;case "gracefulDisconnect":break;case "playlistModified":VUa(this,a);break;case "nowPlaying":XUa(this,a);break;case "onStateChange":WUa(this,a);break;case "onAdStateChange":YUa(this,a);break;case "onVolumeChanged":ZUa(this,a);break;case "onSubtitlesTrackChanged":UUa(this,a);break;case "nowAutoplaying":$Ua(this,a);break;case "autoplayDismissed":this.ea("autoplayDismissed");break;case "autoplayUpNext":this.I=a.params.videoId||null;this.ea("autoplayUpNext",this.I);break;case "onAutoplayModeChanged":this.C=
a.params.autoplayMode;this.ea("autoplayModeChange",this.C);"DISABLED"==this.C&&this.ea("autoplayDismissed");break;case "onHasPreviousNextChanged":aVa(this,a);break;case "requestAssistedSignIn":this.ea("assistedSignInRequested",a.params.authCode);break;case "onLoopModeChanged":this.ea("loopModeChange",a.params.loopMode);break;default:Z8("Unrecognized action: "+a.action)}};
...
g.k.Xr=function(a){Z8("Disconnecting with "+a);g.Fa("yt.mdx.remote.remoteClient_",null,void 0);a9(this);this.ea("beforeDisconnect",a);1==a&&e7();PTa(this.i,a);this.dispose()};
...
g.k.fX=function(a,b){d9(this,a,b);SUa(this)};
...
g.k.HU=function(){g.Ge(this.C)||lVa(this,this.C);this.D=!1};
...
break;case -1:this.Tb(new g.NJ(64));break;case -1E3:this.Tb(new g.NJ(128,{errorCode:"mdx.remoteerror",errorMessage:"\u3053\u306e\u52d5\u753b\u306f\u30ea\u30e2\u30fc\u30c8\u518d\u751f\u3067\u304d\u307e\u305b\u3093\u3002"}))}a=R8(this.Sb).trackData;var b=this.C;(a||b?a&&b&&a.trackName==b.trackName&&a.languageCode==b.languageCode&&a.languageName==b.languageName&&a.kind==b.kind:1)||(this.C=a,lVa(this,a));a=R8(this.Sb);-1===a.volume||Math.round(this.J.getVolume())===a.volume&&this.J.isMuted()===a.muted||
this.X.isActive()||this.FO()}else kVa(this)};
g.k.IM=function(){this.J.ea("mdxpreviousnextchange")};
g.k.qA=function(){z9(this)||kVa(this)};
...
g.k.FO=function(){var a=this;if(z9(this)){var b=R8(this.Sb);this.events.hc(this.ma);b.muted?this.J.mute():this.J.unMute();this.J.setVolume(b.volume);this.ma=this.events.T(this.J,"onVolumeChange",function(c){jVa(a,c)})}};
...
g.k.Tb=function(a){this.B.stop();var b=this.I;if(!g.SJ(b,a)){var c=g.T(a,2);c!==g.T(this.I,2)&&this.J.zt(c);this.I=a;nVa(this.u,b,a)}};g.w(C9,g.W);C9.prototype.wd=function(){this.i.show()};
C9.prototype.Eb=function(){this.i.hide()};
C9.prototype.u=function(){S6("mdx-privacy-popup-cancel");this.Eb()};
C9.prototype.B=function(){S6("mdx-privacy-popup-confirm");this.Eb()};g.w(D9,g.W);D9.prototype.onStateChange=function(a){mVa(this,a.state)};g.w(E9,g.MP);E9.prototype.D=function(){var a=this.J.getOption("remote","receivers");a&&1<a.length&&!this.J.getOption("remote","quickCast")?(this.zo=g.oc(a,this.i,this),g.NP(this,g.tm(a,this.i)),a=this.J.getOption("remote","currentReceiver"),a=this.i(a),this.options[a]&&this.Yh(a),this.enable(!0)):this.enable(!1)};
E9.prototype.i=function(a){return a.key};
E9.prototype.dj=function(a){return"cast-selector-receiver"===a?"\u30ad\u30e3\u30b9\u30c8...":this.zo[a].name};
...
g.k.create=function(){var a=this.player.V(),b=g.RE(a);a={device:"Desktop",app:"youtube-desktop",loadCastApiSetupScript:a.N("mdx_load_cast_api_bootstrap_script"),enableDialLoungeToken:a.N("enable_dial_short_lived_lounge_token"),enableCastLoungeToken:a.N("enable_cast_short_lived_lounge_token")};eVa(b,a);this.subscriptions.push(g.lv("yt-remote-before-disconnect",this.UT,this));this.subscriptions.push(g.lv("yt-remote-connection-change",this.vV,this));this.subscriptions.push(g.lv("yt-remote-receiver-availability-change",this.KM,
...
g.k.load=function(){this.player.cancelPlayback();g.WM.prototype.load.call(this);this.di=new y9(this,this.player,this.Sb);var a=(a=iVa())?a.currentTime:0;var b=v9()?new Q8(p9(),void 0):null;0==a&&b&&(a=M8(R8(b)));0!==a&&this.Wb(a);nVa(this,this.xd,this.xd);this.player.Xk(6)};
...
g.k.KM=function(){var a=[this.Nk],b=a.concat,c=fVa();E8()&&g.Ny("yt-remote-cast-available")&&c.push({key:"cast-selector-receiver",name:"Cast..."});this.zo=b.call(a,c);a=q9()||this.Nk;H9(this,a);this.player.Ma("onMdxReceiversChange")};
